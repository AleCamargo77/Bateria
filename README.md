...
Bateria tem como finalidade que o usuário interaja através das teclas uma simulação de uma bateria ou tocar uma sequência no campo indicado.
...
Inicialmente utilizado HTML e suas tags semânticas para montagem do corpo da página. No CSS, utilizado recursos para estilização e efeitos animados para garantir uma experiência ao usuário mais eficaz. Além de criar a aplicação de maneira responsiva, utilizando o processo de Mobile First. E por fim, trabalhado com funções, arrow functions, array, eventos, método de tempo, condições, manipulação de DOM e data dentro do JavaScript.
  
 Interface:
  
![bateria](https://user-images.githubusercontent.com/105398640/180278277-3cfce4cf-583d-44de-9fac-c8ca4a3e4a65.jpg)





<p dir="auto">Link para acessar o projeto: <a href="https://alecamargo77.github.io/bateria/"> Bateria </a></p>
